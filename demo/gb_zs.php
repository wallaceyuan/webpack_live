...
<head>
    ...
    <meta name="Keywords" content="直播回看,广播回听,视频直播, 新闻直播, 新闻直播间, 搞笑视频, 明星访谈直播, 电影直播, 电视剧直播, 天气预报" />
    <meta name="Description" content="直播回看,广播回听,看看新闻网24小时直播流。视频直播重大事件、直播突发新闻、直播权威发布、直播电影电视剧发布并精选每日国际与国内视频新闻、社会新闻、体育新闻、娱乐 新闻、财经新闻。每天不同时段播出视频资讯、新闻评论节目，搜集论坛热点、汇聚搞笑视频，发布天气预报并可通过视频参与直播。" />
    <title><?php echo $navinfor[title]?>_看看新闻网</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <script type="text/javascript">
        var now = 'gb';var hkId = '<?php echo $navinfor[id]?>';var mid = '622';//var mid = '<?php echo $navinfor[classid]?>';
...
<img src="http://skin.kankanews.com/v6/2016live/pc/app/images/live-index.png" class="page-bg">
...
<div class="non-live-box hidden clearfix">
    ...
    <div class="aside live-Interaction">
        <div class="live-tabs clearfix">
            <h3 class="boss live-tabs-width2 live-tabs-current" data-target="live-program" data-action="电视回看">广播回听</h3>
